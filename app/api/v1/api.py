...
from app.api.v1.endpoints.privacy_policy import router as privacy_policy_router
...
api_router.include_router(privacy_policy_router, prefix="/privacy-policy", tags=["privacy-policy"])